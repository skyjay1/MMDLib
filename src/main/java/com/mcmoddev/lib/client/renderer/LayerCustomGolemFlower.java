...
public class LayerCustomGolemFlower implements LayerRenderer<EntityCustomGolem> {
	
	private final RenderCustomGolem ironGolemRenderer;

	public LayerCustomGolemFlower(RenderCustomGolem ironGolemRendererIn) {
		this.ironGolemRenderer = ironGolemRendererIn;
	}

	public void doRenderLayer(EntityCustomGolem entitylivingbaseIn, float limbSwing, float limbSwingAmount,
